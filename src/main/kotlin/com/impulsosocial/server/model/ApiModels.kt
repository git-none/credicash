...
// Recuperación de contraseña exclusivamente mediante Telegram.
data class TelegramPasswordResetRequest(
...
data class TelegramPasswordResetResponse(
    val message: String,
    val telegramUrl: String? = null,
    val expiresInMinutes: Long,
    val status: String = "CODE_SENT",
    val nextStep: String = "RESET_ACCESS"
)

data class TelegramPasswordResetConfirmRequest(
    val identifier: String,
