...
class OperationalRealtimeNotifier(
    ...
    fun start(scope: CoroutineScope) {
        ...
        val job = scope.launch(Dispatchers.IO) {
            ...
            while (isActive && !stopping) {
                ...
                try {
                    openRealtimeConnection("Credicash-Realtime-Operational").use { connection ->
                        ...
                        try {
                            ...
                            logger.info("Credicash: canal privado de cambios operativos conectado.")
                    ...
                    if (lastWarnAtMs == 0L || now - lastWarnAtMs >= 30_000L) {
                        logger.warn(
                            "Credicash: canal operativo temporalmente no disponible; nuevo intento en {} s. Causa: {}",
                            waitMs / 1_000L,
    ...
    fun stop() {
        ...
        logger.info("Credicash: canal privado de cambios operativos detenido limpiamente.")
    }
